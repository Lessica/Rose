#import "RSETwitterSubPrefsListController.h"

BOOL enableTwitterSection = NO;

@implementation RSETwitterSubPrefsListController
...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.rosepreferences.plist"]) {
        enableTwitterSection = YES;
        [preferences setBool:enableTwitterSection forKey:@"EnableTwitterSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnableTwitterSection"]) {
        enableTwitterSection = YES;
        [preferences setBool:enableTwitterSection forKey:@"EnableTwitterSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnableTwitterSection"] isEqual:@(NO)]) {
        enableTwitterSection = YES;
        [preferences setBool:enableTwitterSection forKey:@"EnableTwitterSection"];
        [self toggleCellState:YES];   
    } else if ([[preferences objectForKey:@"EnableTwitterSection"] isEqual:@(YES)]) {
        enableTwitterSection = NO;
        [preferences setBool:enableTwitterSection forKey:@"EnableTwitterSection"];
