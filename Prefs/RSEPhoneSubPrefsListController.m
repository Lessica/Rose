#import "RSEPhoneSubPrefsListController.h"

BOOL enablePhoneSection = NO;

@implementation RSEPhoneSubPrefsListController
...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:SZ_JBROOT_NS(@"/var/mobile/Library/Preferences/love.litten.rosepreferences.plist")]) {
        enablePhoneSection = YES;
        [preferences setBool:enablePhoneSection forKey:@"EnablePhoneSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnablePhoneSection"]) {
        enablePhoneSection = YES;
        [preferences setBool:enablePhoneSection forKey:@"EnablePhoneSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnablePhoneSection"] isEqual:@(NO)]) {
        enablePhoneSection = YES;
        [preferences setBool:enablePhoneSection forKey:@"EnablePhoneSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnablePhoneSection"] isEqual:@(YES)]) {
        enablePhoneSection = NO;
        [preferences setBool:enablePhoneSection forKey:@"EnablePhoneSection"];
